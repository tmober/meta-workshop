...
```
It looks like we have quitea few influential points based on Cook's distance. Normally, we would want to double-check these and make sure they were extracted correctly. For now, we will proceed by excluding these from subsequent meta-regression analyses.  
